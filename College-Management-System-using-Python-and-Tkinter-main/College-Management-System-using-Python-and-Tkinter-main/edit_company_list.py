...
root =Tk()
root.title("Edit Institutions List")
...
def add():
    if NameEntry.get()=="" or YearEntry.get(1.0, "end-1c")=="" or DepartmentEntry.get(1.0, "end-1c")=="":
       messagebox.showerror("Error","All fields are required")
        ...
        db=mysql.connector.connect(host="localhost",user="root",password="",database="college_db")
        mycursor=db.cursor()
        try:
...
#heading label
college=Label(header, text="SMIU College",font=("Helvetica", 28,"bold"), bg = "brown",fg="#eae2b7")
college.place(x=0, y=10, width=900)
#Profile frame
